...
--
-- Database: `fraudauditor`
--
CREATE DATABASE IF NOT EXISTS `fraudauditor` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fraudauditor`;
...
('2uy779zxwo9mku2yf4yzq13ejo80xxth', 'eyJ1c2VyaWQiOjJ9:1qN7cv:yIQpmL6o4gl9hHOfm6-y0LagYpDeZFlxKW5t75UBTJM', '2023-08-05 08:06:09.226216'),
...
('g9bkmb60wcf37w1znytgjn87op44527j', 'eyJ1c2VyaWQiOjN9:1qN7wb:WgLFAt3-HMA594sK_Juoj0WWCE5b9fTOocmeNGojNPc', '2023-08-05 08:26:29.970708'),
...
('oi0hnec7e24c8l8dk2402alostlartuo', 'eyJ1c2VyaWQiOjF9:1qN73n:6VtqTOv69Go-AeUK6itBQogo_09ruLWhloSHNWfgJyI', '2023-08-05 07:29:51.769742'),
...
(29, 'Graph Neural Network-GNN', '55.84415584415584'),
(30, 'SVM', '54.54545454545454'),
(31, 'Logistic Regression', '53.896103896103895'),
(32, 'Gradient Boosting Classifier', '53.246753246753244');
...
CREATE TABLE IF NOT EXISTS `remote_user_fraud_detection` (
  ...
  `ClaimID` varchar(300) NOT NULL,
  `ClaimDt` varchar(300) NOT NULL,
  `Provider` varchar(300) NOT NULL,
  `Sun_Insured` varchar(300) NOT NULL,
  `InscClaimAmtReimbursed` varchar(300) NOT NULL,
  `AttendingPhysician` varchar(300) NOT NULL,
  `ClmDiagnosisCode_1` varchar(300) NOT NULL,
  `Claimed_Amount` varchar(300) NOT NULL,
  `Glucose` varchar(300) NOT NULL,
  `BloodPressure` varchar(300) NOT NULL,
  `SkinThickness` varchar(300) NOT NULL,
  `Insulin` varchar(300) NOT NULL,
  `BMI` varchar(300) NOT NULL,
  `DiabetesPedigreeFunction` varchar(300) NOT NULL,
...
INSERT INTO `remote_user_fraud_detection` (`id`, `Fid`, `ClaimID`, `ClaimDt`, `Provider`, `Sun_Insured`, `InscClaimAmtReimbursed`, `AttendingPhysician`, `ClmDiagnosisCode_1`, `Claimed_Amount`, `Glucose`, `BloodPressure`, `SkinThickness`, `Insulin`, `BMI`, `DiabetesPedigreeFunction`, `Age`, `Prediction`) VALUES
(1, '10.42.0.211-104.192.110.245-38568-443-6', 'CLM529356', 'CLM529356', 'PRV55951', '4156228.095', '60', 'PHY381511', '1828', '17434', '110', '92', '0', '0', '37.6', '0.191', '30', 'Fraud Found'),
(2, '172.217.10.238-10.42.0.42-80-39769-6', 'CLM626038', '12-10-22', 'PRV53918', '4708644.325', '500', 'PHY330576', '3569', '20936', '119', '80', '35', '0', '29', '0.263', '29', 'Fraud Found'),
(4, '172.217.12.206-10.42.0.151-443-40419-6', 'CLM226681', '04-03-22', 'PRV52935', '3501280.305', '30', 'PHY341325', '4272', '7912', '145', '82', '19', '110', '22.2', '0.245', '57', 'No Fraud Found'),
(5, '10.42.0.42-111.202.114.77-53182-443-6', 'CLM603198', '28-09-22', 'PRV55865', '4038225.021', '0', 'PHY373682', 'V4581', '153451', '118', '72', '19', '0', '23.1', '1.476', '46', 'No Fraud Found'),
(6, '10.42.0.42-103.235.46.211-39424-443-6', 'CLM523157', '13-08-22', 'PRV56835', '3492890.316', '60', 'PHY373512', 'V8302', '10391', '73', '50', '10', '0', '23', '0.248', '21', 'Fraud Found');
