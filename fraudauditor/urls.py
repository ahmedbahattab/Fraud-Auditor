"""fraudauditor URL Configuration
...
from fraudauditor import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Fraud_In_Health_Insurance/$', remoteuser.Predict_Fraud_In_Health_Insurance, name="Predict_Fraud_In_Health_Insurance"),
    ...
    url(r'^View_Prediction_Of_Fraud_In_Health_Insurance_Ratio/$', serviceprovider.View_Prediction_Of_Fraud_In_Health_Insurance_Ratio, name="View_Prediction_Of_Fraud_In_Health_Insurance_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Fraud_In_Health_Insurance/$', serviceprovider.View_Prediction_Of_Fraud_In_Health_Insurance, name="View_Prediction_Of_Fraud_In_Health_Insurance"),
